  ...
  <body>
    ...
    <div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#">Our Website Name</a>
        </div>
    ...
    <div class="jumbotron">
      <div class="container">
        ...
        <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. It was popularised in the <strong>1960s</strong> with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum</p>
    ...
    <div id="who">
      <div class="container homepage">
        <img src="https://i.pinimg.com/564x/3f/49/93/3f49936e28ea7108c6a73f1712e4e7fb.jpg" alt="MASSIVE Academy" title="MASSIVE Academy" width="180px" height="180px" style="margin-top: -30px">
        <h2>Who We Are</h2>
        <hr>
    ...
    <footer>
      <div class="container">
        <p class="text-center">Our Website Copyright &copy; 2021</p>
      </div>
    </footer>
